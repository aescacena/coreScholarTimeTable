...
import 'package:scholar_time_table_app/core/instance/teacher/domain/Teacher.dart';
import 'package:scholar_time_table_app/core/instance/teacher/infrastructure/InMemoryTeacherRepository.dart';
...
void main(){
  ...
  group("Constructor", (){
    ...
    test("Should create from File", (){
      // Arrange
      var file = File(Directory.current.path+'/lib/core/resource/data/Teachers.json');
