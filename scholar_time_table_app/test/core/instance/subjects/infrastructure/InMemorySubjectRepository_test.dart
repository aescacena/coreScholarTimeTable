...
import 'package:scholar_time_table_app/core/instance/subjects/domain/Subject.dart';
import 'package:scholar_time_table_app/core/instance/subjects/infrastructure/InMemorySubjectRepository.dart';
...
void main(){
  ...
  group("Constructor", () {
    ...
    test("Should create from File", () {
      // Arrange
      var file = File(Directory.current.path+'/lib/core/resource/data/Subjects.json');
