...
import 'package:scholar_time_table_app/core/instance/course/domain/Course.dart';
import 'package:scholar_time_table_app/core/instance/course/infrastructure/InMemoryCourseRepository.dart';
...
void main(){
  ...
  group("Constructor", (){
    ...
    test("Should create from File", (){
      // Arrange
      var file = File(Directory.current.path+'/lib/core/resource/data/Courses.json');
